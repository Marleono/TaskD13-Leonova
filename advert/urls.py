...
from .views import AnnouncementsList, AnnouncementDetail, AnnouncementCreate, AnnouncementUpdate, AnnouncementDelete, ResponseCreate, ResponseList
...
urlpatterns = [
    ...
    path('<int:pk>/update/', AnnouncementUpdate.as_view(), name='announcement_create'),
